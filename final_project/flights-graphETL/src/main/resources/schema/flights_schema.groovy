...
// vertex labels
schema.vertexLabel('airport').ifNotExists().partitionBy('airport_code', Text).property('airport_name', Text).property('city', Text).property('coordinates', Point).property('timezone', Text).create()
